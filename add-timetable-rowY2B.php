...
<?php require_once('Service/add-timetable-rowY2B-service.php'); ?>
...
<div class="header">
    ...
    <h2 style="padding-left:4%">Second Year-Batch B</h2>
    ...
    <thead>
		...
		<form action="add-timetable-rowY2B.php" method="post" class="userform">
		<tbody>
		<tr>
