...
<?php require_once('Service/add-timetable-rowY3B-service.php'); ?>
...
<div class="header">
    ...
    <h2 style="padding-left:4%">Third Year-Batch B</h2>
    ...
    <thead>
		...
		<form action="add-timeTable-rowY3B.php" method="post" class="userform">
		<tbody>
		<tr>
