...
<?php require_once('Service/add-timetable-rowY1B-service.php'); ?>
...
<div class="header">
    ...
    <h2 style="padding-left:4%">First Year-Batch B</h2>
    ...
    <thead>
		...
		<form action="add-timetable-rowY1B.php" method="post" class="userform">
		<tbody>
		<tr>
