...
<?php require_once('Service/add-timetable-rowY1-service.php'); ?>
...
<div class="header">
    ...
    <h2 style="padding-left:4%">Add First Year Exam Timetable</h2>
    ...
    <thead>
		...
		<form action="add-timeTable-rowY1.php" method="post" class="userform">
		<tbody>
		<tr>
