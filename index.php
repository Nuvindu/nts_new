...
<body>
    ...
    <section id="about">
        <div class="about container">
            ...
            <div class="col-right">
                ...
                <p><b>Formal nursing education was started in 1939 in Sri Lanka at Nurses training school (NTS) in
                        Colombo. Thereafter, it was expanded to 17 other Schools of Nursing throughout the country
                        conferring a basic Diploma in Nursing.
                        Nts Galle offers a 3 year diploma program.Twenty different modules are included in the program.
                        Academic staff consists with qualified lecturers.
                        We train nurses for state hospitals and other state health institutions. There is a principal
                        for each NTS.
                        NTS is the best place where you can gain both theoritical and practical knowledge at the same
                        time.</b>
                </p>
    ...
    <section id="footer">
        <div class="footer container">
            <div class="brand">
                <h1><span>N</span>urses <span>T</span>raining <span>S</span>chool</h1>
            </div>
            <h2>Learning Management System</h2>
            <div class="social-icon">
                <div class="social-item">
                    <a
                        href="https://www.facebook.com/pages/category/College---University/College-Of-Nursing-Galle-194022190708654/"><img
                            src="https://img.icons8.com/bubbles/100/000000/facebook-new.png" /></a>
                </div>

                <div class="social-item">
                    <a
                        href="https://maps.google.lk/maps/ms?gl=lk&ptab=2&ie=UTF8&oe=UTF8&msa=0&msid=211602232416828735618.0004b5d3f3705261ef07d"><img
                            src="https://img.icons8.com/bubbles/100/000000/map.png" /></a>
                </div>
            </div>
